...
export function getCategoryColor(category: string | null): string {
  ...
  if (category.includes("野生絶滅") || category.includes("EW")) return CATEGORY_COLORS.EW;
  if (category.includes("CR") || category.includes("絶滅危惧Ⅰ類")) return CATEGORY_COLORS.CR;
  if (category.includes("EN")) return CATEGORY_COLORS.EN;
  if (category.includes("VU") || category.includes("絶滅危惧Ⅱ類")) return CATEGORY_COLORS.VU;
  if (category.includes("NT") || category.includes("準絶滅危惧")) return CATEGORY_COLORS.NT;
  if (category.includes("DD") || category.includes("情報不足")) return CATEGORY_COLORS.DD;
...
export function getCategoryClass(category: string): string {
  ...
  if (category.includes("野生絶滅") || category.includes("EW")) return "category-ew";
  ...
  if (category.includes("準絶滅") || category.includes("NT")) return "category-nt";
  if (category.includes("情報不足") || category.includes("DD")) return "category-dd";
...
export function isSameCategory(category: string, filterCategory: string): boolean {
  ...
  for (const variations of Object.values(CATEGORY_MAPPINGS)) {
    if (variations.includes(category) && variations.includes(filterCategory)) return true;
  }
  return false;
}